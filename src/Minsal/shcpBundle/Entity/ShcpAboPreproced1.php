...
class ShcpAboPreproced1
{
     ...
     * @var string
     *
     * @ORM\Column(name="prep1_temp", type="decimal", precision=2, scale=1, nullable=true)
     */
    private $prep1Temp;
     ...
     * @var string
     *
     * @ORM\Column(name="prep1_hemoglob", type="decimal", precision=2, scale=1, nullable=true)
     */
